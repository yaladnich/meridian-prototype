...
Головна: https://yaladnich.github.io/meridian-prototype/ (перша версія — /v1.html, той самий підшипник відео — /video.html)
...
- «Послуги»: підшипник у SVG (креслення → заливки → розбір) грає сам, кроки змінюються за таймером; версія з відео WebM — /video.html;
